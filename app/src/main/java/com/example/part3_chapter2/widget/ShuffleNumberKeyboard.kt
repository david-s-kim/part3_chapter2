package com.example.part3_chapter2.widget
...
import com.example.part3_chapter2.databinding.WidgetShuffleNumberKeyboardBinding
import kotlin.random.Random

class ShuffleNumberKeyboard @JvmOverloads
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttrs: Int = 0) :
    GridLayout(context, attrs, defStyleAttrs), View.OnClickListener {
